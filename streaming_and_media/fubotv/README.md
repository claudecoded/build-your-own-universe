# Build Your Own Fubotv

This open-source engineering blueprint module contains the system scaffolding to help you build a decentralized version of FUBOTV.
